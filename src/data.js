...
const TOWERS={
 arrow:{name:'速射弩塔',role:'SINGLE TARGET',power:1,unlock:0,shape:[1.0,1.35,1.0],cost:45,c:'#7ee787',air:true,hotkey:1,
  desc:'廉价高频的单体射手，对<b>空中单位</b>同样有效。开局主力。',
 ...
 cannon:{name:'重型火炮',role:'SPLASH · GROUND',power:2,unlock:0,shape:[1.45,0.95,1.45],cost:130,c:'#ffa14a',air:false,hotkey:2,
  desc:'抛射炮弹造成<b>范围爆炸</b>，无法打空中。对付集群极佳。',
 ...
 frost:{name:'霜寒之柱',role:'CONTROL',power:1,unlock:1,shape:[0.95,1.55,0.95],cost:95,c:'#5fd0ff',air:true,hotkey:3,
  desc:'冰弹落地形成<b>寒冰领域</b>，持续减速；概率直接冻结。为你争取风筝空间。',
  dmg:[7,11,15,21],rate:[1.3,1.4,1.5,1.6],range:[4.0,4.3,4.6,5.0],splash:[1.1,1.2,1.3,1.45],
  slow:[.35,.43,.5,.58],up:[75,130,220],
 ...
 tesla:{name:'电弧线圈',role:'CHAIN',power:2,unlock:2,shape:[0.9,1.8,0.9],cost:215,c:'#8b6cff',air:true,hotkey:4,
  desc:'闪电在敌人之间<b>连锁跳跃</b>。密集虫群的克星。',
  dmg:[25,36,52,72],rate:[1.2,1.3,1.4,1.5],range:[4.0,4.3,4.6,4.9],chain:[2,3,3,4],up:[130,215,355],
 ...
 flame:{name:'炽炎喷口',role:'DOT · GROUND',power:2,unlock:1,shape:[1.35,0.8,1.35],cost:115,c:'#ff6b3d',air:false,hotkey:5,
  desc:'持续火焰射流并叠加<b>灼烧</b>。灼烧<b>无视护甲</b>，适合贴身守核。',
  dmg:[28,42,60,84],rate:[6,6,6,6],range:[3.2,3.5,3.8,4.1],burn:[10,15,21,29],up:[95,160,270],
 ...
 sniper:{name:'轨道狙击',role:'LONG RANGE',power:3,unlock:3,shape:[0.8,2.0,0.8],cost:340,c:'#ffd54a',air:true,hotkey:6,
  desc:'超远射程高伤单发，<b>无视护甲</b>，默认优先攻击最强目标。',
  dmg:[88,132,192,275],rate:[.55,.6,.66,.72],range:[9,9.6,10.2,11],up:[165,280,470],pierceArmor:true,
...
const PICKUPS={
 medkit:{n:'医疗包',   gl:'✚', c:'#6ee7a8', life:26, d:'立即回复 70 点生命'},
